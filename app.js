...
const APP_VERSION = 'v77 · Responsive Parte 5: Inventario en celular (familias en pestañas, editor pantalla completa)';  // se muestra en el menú de cuenta para confirmar la versión
